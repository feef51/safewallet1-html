...
! function (u, p) {
    ...
    u.ClassBody = function () {
        ...
        u.BreakClass("." + s, d.lg, {
            ...
            u.BreakClass("." + s, d.lg), u.BreakClass("." + r, d.lg, {
                classAdd: e
            })
        })
    }, u.Prettify = function () {
        ...
        function e(t, e) {
            ...
            a.text = t.text || a.text, a.done = t.done || a.done, a.fail = t.fail || a.fail;
        ...
        var a = "info" === (e = e || "info") ? "ni ni-info-fill" : "success" === e ? "ni ni-check-circle-fill" : "error" === e ? "ni ni-cross-circle-fill" : "warning" === e ? "ni ni-alert-fill" : "",
            ...
            i = n ? f(i, n) : i;
        i.position = i.position ? "toast-" + i.position : "toast-bottom-right", i.icon = "auto" === i.icon ? a : i.icon || "", i.ui = i.ui ? " " + i.ui : "", a = "" !== i.icon ? '<span class="toastr-icon"><em class="icon ' + i.icon + '"></em></span>' : "", "" !== (t = "" !== t ? a + '<div class="toastr-text">' + t + "</div>" : "") && (!0 === i.clear && toastr.clear(), a = {
            closeButton: !0,
            debug: !1,
            newestOnTop: !1,
            progressBar: !1,
        ...
        }, toastr.options = f(a, i), toastr[e](t))
        ...
        var n = p(t || ".toggle"),
            ...
            r = e ? f(t, e) : t;
        u.TGL.screen(o), n.on("click", function (t) {
            s = this, u.Toggle.trigger(p(this).data("target"), r), t.preventDefault()
        }), l.on("mouseup", function (t) {
            var e, n, a, i;
            s && (e = p(s), n = p(".select2-container"), a = p(".datepicker-dropdown"), i = p(".ui-timepicker-container"), e.is(t.target) || 0 !== e.has(t.target).length || o.is(t.target) || 0 !== o.has(t.target).length || n.is(t.target) || 0 !== n.has(t.target).length || a.is(t.target) || 0 !== a.has(t.target).length || i.is(t.target) || 0 !== i.has(t.target).length || (u.Toggle.removed(e.data("target"), r), s = !1))
        }), c.on("resize", function () {
            o.each(function () {
        ...
        var n = t || ".nk-menu-toggle",
            ...
            a = e ? f(t, e) : t;
        p(n).on("click", function (t) {
            (u.Win.width < d.lg || p(this).parents().hasClass(r)) && u.Toggle.dropMenu(p(this), a), t.preventDefault()
        })
        ...
        p(t || '[data-toggle="modal"]').on("click", function () {
            ...
            t && "#" !== t && n ? n.find('[href="' + t + '"]').tab("show") : n && (n = n.find(".nk-nav.nav-tabs"), n = p(n[0]).find('[data-toggle="tab"]'), p(n[0]).tab("show"))
        })
        ...
        u.BS.menutip("a.nk-menu-link"), u.BS.tooltip(".nk-tooltip"), u.BS.tooltip(".btn-tooltip", {
            placement: "top"
        }), u.BS.tooltip('[data-toggle="tooltip"]'), u.BS.tooltip(".tipinfo,.nk-menu-tooltip", {
            placement: "right"
        }), u.BS.popover('[data-toggle="popover"]'), u.BS.progress("[data-progress]"), u.BS.fileinput(".custom-file-input"), u.BS.modalfix(), u.BS.ddfix(), u.BS.tabfix()
        ...
        u.Knob.init(), u.Range.init(), u.Select2.init(), u.Dropzone.init(), u.Slider.init(), u.DataTable.init()
    }, u.TGL.init = function () {
        ...
        u.coms.docReady.push(u.OtherInit), u.coms.docReady.push(u.Prettify), u.coms.docReady.push(u.ColorBG), u.coms.docReady.push(u.ColorTXT), u.coms.docReady.push(u.Copied), u.coms.docReady.push(u.Ani.init), u.coms.docReady.push(u.TGL.init), u.coms.docReady.push(u.BS.init), u.coms.docReady.push(u.Validate.init), u.coms.docReady.push(u.Picker.init), u.coms.docReady.push(u.Addons.Init), u.coms.docReady.push(u.Wizard), u.coms.winLoad.push(u.ModeSwitch)
    }, u.init()
}(NioApp, jQuery);
